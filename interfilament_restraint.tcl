...
set fp [open "avg_closest_87CB_89CB.dat" w]
...
for {set i 0} {$i < $nf} {incr i} {
	...
	foreach seg1 $prot1seg {
		set shortest_seg_dist_prot1 [shortestdist $prot2segall $seg1 $residue1 $residue2 $atom1 $atom2]
	...
	foreach seg2 $prot2seg {
	        set shortest_seg_dist_prot2 [shortestdist $prot1segall $seg2 $residue1 $residue2 $atom1 $atom2]
